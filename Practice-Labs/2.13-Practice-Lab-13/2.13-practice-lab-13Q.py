"""
Using the template code provided, fix the code that is vulnerable 
to least privilege. You will need to change the permission level 
appropriately for each level of users as follows:
...
my_dict.txt contains a dictionary list of authorized admin users and 
their username:
